...
public void createNewProduct() {
   ...
   Product product1 = new Product("Jotain", "Valjaat", "M", "Yellow", 13.0, 20, "blaa" , "blaa" , manufacturer1);
...
public void searchByName (){
    ...
    Product product2 = new Product("Tuote", "Hihna", "M", "Blue", 13.0, 20, "blaa" , "blaa", manufacturer2);
